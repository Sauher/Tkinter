...
def scrum(foablak):
    ...
    kerdes1.place(relx=1, rely=1, anchor=NW)
    kerdes2.place(relx=1, rely=1, anchor=NW)
    kerdes3.place(relx=1, rely=1, anchor=NW)
    kerdes4.place(relx=1, rely=1, anchor=NW)
    kerdes5.place(relx=1, rely=1, anchor=NW)
    valaszgomb1_1.place(relx=1, rely=1, anchor=NW)
    valaszgomb1_2.place(relx=1, rely=1, anchor=NW)
    valaszgomb1_3.place(relx=1, rely=1, anchor=NW)
    valaszgomb2_1.place(relx=1, rely=1, anchor=NW)
    valaszgomb2_2.place(relx=1, rely=1, anchor=NW)
    valaszgomb2_3.place(relx=1, rely=1, anchor=NW)
    valaszgomb3_1.place(relx=1, rely=1, anchor=NW)
    valaszgomb3_2.place(relx=1, rely=1, anchor=NW)
    valaszgomb3_3.place(relx=1, rely=1, anchor=NW)
    valaszgomb4_1.place(relx=1, rely=1, anchor=NW)
    valaszgomb4_2.place(relx=1, rely=1, anchor=NW)
    valaszgomb4_3.place(relx=1, rely=1, anchor=NW)
    valaszgomb5_1.place(relx=1, rely=1, anchor=NW)
    valaszgomb5_2.place(relx=1, rely=1, anchor=NW)
    valaszgomb5_3.place(relx=1, rely=1, anchor=NW)
